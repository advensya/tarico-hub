 ...
 * @returns The passed schema.
 */
declare function fallbackAsync<
  const TSchema extends
    | BaseSchema<unknown, unknown, BaseIssue<unknown>>
    | BaseSchemaAsync<unknown, unknown, BaseIssue<unknown>>,
 ...
 */
type KeyOf$1<TValue> = IsAny<TValue> extends true
  ? never
 ...
 * @returns The default values.
 */
declare function getDefaultsAsync<
  const TSchema extends
    | BaseSchema<unknown, unknown, BaseIssue<unknown>>
    | BaseSchemaAsync<unknown, unknown, BaseIssue<unknown>>
    | LooseObjectSchema<
 ...
 * @returns The fallback values.
 */
declare function getFallbacksAsync<
  const TSchema extends
    | BaseSchema<unknown, unknown, BaseIssue<unknown>>
    | BaseSchemaAsync<unknown, unknown, BaseIssue<unknown>>
    | LooseObjectSchema<
 ...
 * @beta
 */
type InferMetadata<TSchema extends Schema$c> = BaseSchema<
  any,
  any,
  any
> extends TSchema
 ...
 * Schema type.
 */
type Schema$9 = SchemaWithoutPipe<
  | LooseObjectSchema<ObjectEntries, ErrorMessage<LooseObjectIssue> | undefined>
  | LooseObjectSchemaAsync<
      ObjectEntriesAsync,
      ErrorMessage<LooseObjectIssue> | undefined
 ...
 * Schema type.
 */
type Schema$8 = SchemaWithoutPipe<
  | LooseObjectSchema<ObjectEntries, ErrorMessage<LooseObjectIssue> | undefined>
  | ObjectSchema<ObjectEntries, ErrorMessage<ObjectIssue> | undefined>
  | ObjectWithRestSchema<
      ObjectEntries,
...
> = TSchema extends
  ...
  ? Omit<TSchema, "entries" | "~standard" | "~run" | "~types"> & {
       ...
       */
      readonly "~standard": StandardProps<
        InferObjectInput<PartialEntries$1<TEntries, TKeys>>,
      ...
      readonly "~types"?:
        | {
            ...
            readonly output: InferObjectOutput<
              PartialEntries$1<TEntries, TKeys>
            >;
 ...
 * @returns An object schema.
 */
declare function partial<const TSchema extends Schema$8>(
  schema: TSchema
 ...
 * Schema type.
 */
type Schema$7 = SchemaWithoutPipe<
  | LooseObjectSchemaAsync<
      ObjectEntriesAsync,
      ErrorMessage<LooseObjectIssue> | undefined
    >
 ...
 * @returns An object schema.
 */
declare function partialAsync<const TSchema extends Schema$7>(
  schema: TSchema
 ...
 * The schema type.
 */
type Schema$6 = SchemaWithoutPipe<
  | LooseObjectSchema<ObjectEntries, ErrorMessage<LooseObjectIssue> | undefined>
  | LooseObjectSchemaAsync<
      ObjectEntriesAsync,
      ErrorMessage<LooseObjectIssue> | undefined
 ...
 * Schema type.
 */
type Schema$5 = SchemaWithoutPipe<
  | LooseObjectSchema<ObjectEntries, ErrorMessage<LooseObjectIssue> | undefined>
  | ObjectSchema<ObjectEntries, ErrorMessage<ObjectIssue> | undefined>
  | ObjectWithRestSchema<
      ObjectEntries,
 ...
 * @returns An object schema.
 */
declare function required<const TSchema extends Schema$5>(
  schema: TSchema
...
declare function required<
  const TSchema extends Schema$5,
 ...
 * @returns An object schema.
 */
declare function requiredAsync<const TSchema extends Schema$4>(
  schema: TSchema
 ...
 * @returns An object schema.
 */
declare function requiredAsync<
  const TSchema extends Schema$4,
  const TMessage extends ErrorMessage<NonOptionalIssue> | undefined
>(
  schema: TSchema,
  message: TMessage
 ...
 * @returns The parse result.
 */
declare function safeParseAsync<
  const TSchema extends
    | BaseSchema<unknown, unknown, BaseIssue<unknown>>
    | BaseSchemaAsync<unknown, unknown, BaseIssue<unknown>>
>(
 ...
 * @returns The parser function.
 */
declare function safeParserAsync<
  const TSchema extends
    | BaseSchema<unknown, unknown, BaseIssue<unknown>>
    | BaseSchemaAsync<unknown, unknown, BaseIssue<unknown>>
 ...
 */
type Merge<TFirstObject, TSecondObject> = Omit<
  TFirstObject,
 ...
 * Error message type.
 */
type ErrorMessage<TIssue extends BaseIssue<unknown>> =
  | ((issue: TIssue) => string)
  | string;
/**
 * Default type.
 ...
 * Tuple items type.
 */
type TupleItems = MaybeReadonly<
  BaseSchema<unknown, unknown, BaseIssue<unknown>>[]
>;
/**
 * Tuple items async type.
 */
type TupleItemsAsync = MaybeReadonly<
  (
    | BaseSchema<unknown, unknown, BaseIssue<unknown>>
    | BaseSchemaAsync<unknown, unknown, BaseIssue<unknown>>
  )[]
...
> = TSchema extends SchemaWithPipe<infer TPipe>
  ...
  : TSchema extends
      | ExactOptionalSchema<
          infer TWrapped,
          Default<BaseSchema<unknown, unknown, BaseIssue<unknown>>, never>
        >
 ...
 */
interface BlobSchema<TMessage extends ErrorMessage<BlobIssue> | undefined>
 ...
 */
interface BooleanSchema<TMessage extends ErrorMessage<BooleanIssue> | undefined>
 ...
 */
interface DateSchema<TMessage extends ErrorMessage<DateIssue> | undefined>
 ...
 */
declare function enum_<const TEnum extends Enum>(
  enum__: TEnum
 ...
 */
declare function instance<TClass extends Class>(
  class_: TClass
 ...
 */
declare function literal<const TLiteral extends Literal>(
  literal_: TLiteral
 ...
 */
interface NanSchema<TMessage extends ErrorMessage<NanIssue> | undefined>
 ...
 */
interface NeverSchema<TMessage extends ErrorMessage<NeverIssue> | undefined>
 ...
 * Union options type.
 */
type UnionOptions = MaybeReadonly<
  BaseSchema<unknown, unknown, BaseIssue<unknown>>[]
>;
/**
 ...
 */
type UnionOptionsAsync = MaybeReadonly<
  (
    | BaseSchema<unknown, unknown, BaseIssue<unknown>>
    | BaseSchemaAsync<unknown, unknown, BaseIssue<unknown>>
  )[]
 ...
 */
interface NullSchema<TMessage extends ErrorMessage<NullIssue> | undefined>
 ...
 */
interface VoidSchema<TMessage extends ErrorMessage<VoidIssue> | undefined>
 ...
 */
type ContentRequirement<TInput extends ContentInput> =
 ...
 * Extracts the exact keys of a tuple, array or object.
 */
type KeyOf<TValue> = IsAny<TValue> extends true
  ? never
  : TValue extends readonly unknown[]
  ? number extends TValue["length"]
    ? "$"
 ...
 * the given value.
 */
type ValidPath<TValue, TPath extends RequiredPath> = TPath extends LazyPath<
  TValue,
  TPath
>
  ? TPath
  : LazyPath<TValue, TPath>;
/**
 ...
 */
declare function getGlobalConfig<const TIssue extends BaseIssue<unknown>>(
 ...
 */
declare function setGlobalMessage(
 ...
 */
declare function getGlobalMessage(
  lang?: string
 ...
 * @param lang The language of the message.
 */
declare function setSchemaMessage(
  message: ErrorMessage<BaseIssue<unknown>>,
  lang?: string
): void;
/**
 ...
 * @returns The error message.
 */
declare function getSchemaMessage(
  lang?: string
): ErrorMessage<BaseIssue<unknown>> | undefined;
/**
 ...
 * @param lang The language of the message.
 */
declare function setSpecificMessage<const TReference extends Reference>(
 ...
 * @returns The error message.
 */
declare function getSpecificMessage<const TReference extends Reference>(
  reference: TReference,
  lang?: string
 ...
 * @param lang The language of the message.
 */
declare function deleteSpecificMessage(
  reference: Reference,
  lang?: string
): void;
 ...
 * @internal
 */
declare function _addIssue<const TContext extends Context>(
  context: TContext & {
    expects?: string | null;
    requirement?: unknown;
    message?:
 ...
 * @internal
 */
declare function _getLastMetadata(
  schema: Schema$1,
 ...
 * @returns The Standard Schema properties.
 */
declare function _getStandardProps<
  TSchema extends
    | BaseSchema<unknown, unknown, BaseIssue<unknown>>
    | BaseSchemaAsync<unknown, unknown, BaseIssue<unknown>>
 ...
 * @internal
 */
declare function _getWordCount(
 ...
 */
declare function entriesFromList<
 ...
 */
declare function isOfKind<
  const TKind extends TObject["kind"],
  const TObject extends {
    kind: string;
  }
>(
  kind: TKind,
